...
<div class="">
    ...
    <form method="post" action="{{ route('subcategory.store') }}"class="row g-3 p-3">
      @csrf
      ...
      <div class="col-md-6 pb-3">
        ...
        <input type="text" class="form-control" id="subcategory_name" name="subcategory_name" value="{{old('bundle_name')}}">
