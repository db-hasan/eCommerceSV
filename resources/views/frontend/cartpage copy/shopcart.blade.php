...
{{-- cart option kaj korate hole id="cartButton" layout theke remove korte hobe
id="cartButton" onno kno jaiga the thaka jabe na --}}

<button type="button" id="cartButton" class="btn btn-outline-success w-50 mb-2">View Cart</button>
...
<!-- Cart template start -->
    <div class="cart-container " id="cartContainer">
        ...
        <hr>
        <button type="button" class="btn btn-outline-success w-100 mb-2">View Cart</button>
    </div>
    <!-- Cart template end -->
